...
*/
  ...
  val scoringFunctions =
    List(ScoringFunction("title", nearBeginning -> 2, notNearBeginning -> -2, nearPageTop -> 1, largeFont -> 1, veryLargeFont -> 2, highlyPunctuated -> -1, lengthBetween(30, 200) -> 2,
      ...
      ScoringFunction("authors", firstname -> 2, lastname -> 4, noLastName -> -2, nearBeginning -> 1.5, nearPageTop -> .5, largeFont -> .5, dominantFont -> -1, highlyPunctuated -> 2,
        lengthBetween(10, 1000) -> 1, initials -> 5, digits -> -10, longColumnWidth -> 2),
      ScoringFunction("affiliations", cities -> 1, states -> 1, nearBeginning -> 1.4, dominantFont -> -1, highlyPunctuated -> 2, lengthBetween(10, 1000) -> 1, university -> 5, referencesText -> -5),
      ...
      ScoringFunction("references", firstname -> 2, lastname -> 4, noLastName -> -2, referencesHeaderText -> 110, referencesText -> 5, nearEnd -> 2, nearBeginning -> -2, dominantFont -> -1, smallFont -> 2, highlyPunctuated -> 2,
        http -> 1),
      ...
      ScoringFunction("acknowledgements", acknowledgementHeaderText -> 100, nearEnd -> 1, nearBeginning -> -1, lengthBetween(10, 200) -> 1, firstname -> 2, lastname -> 2, referencesText -> -10),
