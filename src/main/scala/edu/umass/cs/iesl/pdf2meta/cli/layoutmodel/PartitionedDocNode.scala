 ...
 */
abstract class PartitionedDocNode(override val id: String, override val children: Seq[DocNode], override val localInfo: Option[Iterator[String]], override val localErrors: Option[Iterator[String]],
                                  val strength: Double)
 ...
 */
class WhitespacePartitionedDocNode(override val id: String, override val children: Seq[DocNode], override val localInfo: Option[Iterator[String]], override val localErrors: Option[Iterator[String]],
                                   override val strength: Double) extends PartitionedDocNode(id,children,localInfo,localErrors,strength)
{
  ...
  def makeNonPartition: DocNode = new DocNode(id, children.filter(!_.isInstanceOf[WhitespaceBox]), localInfo, localErrors) { override val secretChildren =  WhitespacePartitionedDocNode.this.secretChildren }
 ...
 */
class LinePartitionedDocNode(override val id: String, override val children: Seq[DocNode], override val localInfo: Option[Iterator[String]], override val localErrors: Option[Iterator[String]],
                             override val strength: Double) extends PartitionedDocNode(id,children,localInfo,localErrors,strength)
{
  override def create(childrenA: Seq[DocNode]) =
  {
